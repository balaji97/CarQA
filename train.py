...
num_channels = 3
train_data = 'gdrive/My Drive/cars_resnet/Car-Recognition/data/train'
valid_data = 'gdrive/My Drive/cars_resnet/Car-Recognition/data/valid'
num_classes = 196
...
if __name__ == '__main__':
    ...
    log_file_path = 'gdrive/My Drive/cars_resnet/Car-Recognition/logs/training.log'
    csv_logger = CSVLogger(log_file_path, append=False)
    early_stop = EarlyStopping('val_acc', patience=patience)
    reduce_lr = ReduceLROnPlateau('val_acc', factor=0.1, patience=int(patience / 4), verbose=1)
    trained_models_path = 'gdrive/My Drive/cars_resnet/Car-Recognition/models/model'
